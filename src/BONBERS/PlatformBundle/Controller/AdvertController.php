...
use BONBERS\PlatformBundle\Form\AdvertEditType;
...
class AdvertController extends Controller
{
  ...
  public function viewAction($id)
  {
    ...
    // $advert est donc une instance de BONBERS\PlatformBundle\Entity\Advert
  ...
  public function deleteAction(Request $request, $id)
  {
    ...
    if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
      ...
      return $this->redirectToRoute('bonbers_platform_home');
    }
    
    return $this->render('BONBERSPlatformBundle:Advert:delete.html.twig', array(
      'advert' => $advert,
      'form'   => $form->createView(),
    ));
  }
  ...
  public function purgeAction($days, Request $request)
  {
    ...
    $purger = $this->get('bonbers_platform.purger.advert');
